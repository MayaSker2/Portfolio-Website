...
const MyProjects = () => {
  ...
  return (
    <section id="projects" className=" bg-dark mt-14 rounded-3xl">
      <div className="container mx-auto px-8 md:px-10 py-10">
        <div className="w-full lg:w-[60vw] mx-auto">
          <h4 className="section-title">Recent Projects</h4>

          <p className="text-sm text-center text-lightpink mt-4 leading-6">
        ...
        <div className="relative">
            ...
            >
                <IoIosArrowForward className="rotate-180 text-3xl" />
            </button>
